      ...
      <div className="about-widget">
        <div style={{ maxWidth: 300, margin: "auto" }}>
          <div
            ...
            style={{
              backgroundImage:
                "url(" +
                `${require("../static/images/Glowish_logo.png")}` +
                ")",
            }}
          ></div>
        </div>
        <div className="about-content">
          ...
          <p className="about-text">
            Glowish là nền tảng chăm sóc da online, dành cho những bạn chưa có
            thời gian, điều kiện đi khám trực tiếp tại các phòng khám da liễu,
            có nhu cầu tìm kiếm các sản phẩm dưỡng da bên ngoài để chăm sóc da.
          </p>
