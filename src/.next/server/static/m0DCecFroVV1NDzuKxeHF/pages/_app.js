...
var initializerDefineProperty = __webpack_require__("3bJw");
...
var applyDecoratedDescriptor = __webpack_require__("c35s");
...
var initializerWarningHelper = __webpack_require__("Bejv");
...
var store_Store = (_class = (_temp = class Store {
  constructor() {
    initializerDefineProperty_default()(this, "likesCount", _descriptor, this);
  }
...
}, _temp), (_descriptor = applyDecoratedDescriptor_default()(_class.prototype, "likesCount", [external_mobx_["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), applyDecoratedDescriptor_default()(_class.prototype, "updateCount", [external_mobx_["action"]], Object.getOwnPropertyDescriptor(_class.prototype, "updateCount"), _class.prototype)), _class);
var storeInstance = new store_Store();
/* harmony default export */ var store = (storeInstance);
...
class _app_MyApp extends app_default.a {
  static getInitialProps(_ref) {
    return asyncToGenerator_default()(function* () {
      ...
      var pageProps = Component.getInitialProps ? yield Component.getInitialProps(ctx) : {};
      return {
        pageProps: pageProps
      };
    })();
