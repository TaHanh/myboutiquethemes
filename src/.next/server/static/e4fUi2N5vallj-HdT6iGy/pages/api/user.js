...
module.exports = __webpack_require__("Krtq");
...
/* harmony import */ var _middleware_database__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("pOxy");
...
handler.use(_middleware_database__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]);
...
/* harmony default export */ __webpack_exports__["default"] = ((req, res) => handler.apply(req, res));
...
const client = new mongodb__WEBPACK_IMPORTED_MODULE_0__["MongoClient"]("mongodb://yp9tdlorbv:yp9tdlorbv@176.9.57.130:27017/yp9tdlorbv", {
  useNewUrlParser: true,
  useUnifiedTopology: true
});
...
async function database(req, res, next) {
  console.log('fndjsfk', "user");
  if (!client.isConnected()) await client.connect();
  req.dbClient = client;
  req.db = client.db("user");
